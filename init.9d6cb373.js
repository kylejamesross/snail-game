...
const gameState = {
  ...
  wake() {
    ...
    (0, _ui.modeScene)(_constants.SCENES[this.scene]);
...
const toggleHighlighted = (icon, show) => {
  const classList = document.querySelector(`.${_constants.ICONS[icon]}-icon`).classList;
